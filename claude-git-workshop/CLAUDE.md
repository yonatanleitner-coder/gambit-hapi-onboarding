...
Project memory for Claude Code. Read `docs/human-plan.md` (the contract) and `docs/ai-plan.md` (the how) before executing. Current stage: **AI Plan → AI Execute gate.** Start at AI Plan §12 task 1 (API spike).
