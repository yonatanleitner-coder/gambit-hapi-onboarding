...
Project memory for Claude Code. Read `docs/human-plan.md` (the contract) and `docs/ai-plan.md` (the how) before executing. Current stage: **AI Execute**, in progress. Tasks 1–3 (API spike, catalog + resolution, state + Phase + contracts) done — see `docs/end-of-session.md`. Next: AI Plan §12 task 4 (providers).
